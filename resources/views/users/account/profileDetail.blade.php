                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-10 col-12">
                        <div class="row px-5 me-2">
                            ...
                            <!-- Business Info -->
                            <div class="col-lg-4 col-md-4 col-12 ms-4" style="padding: 0.5em 1em; margin: 0 0 2em 0; background: white; box-shadow: 0 3px 5px rgba(0, 0, 0, 0.22);">
                                <h4 class="mt-1">Business Info</h4>
                                <h6>
                                    Website
                                    <a href="https:testaaaaaaaa.com" style="display: block; word-wrap: break-word; max-width: 300px">https:testaaaaaaaa.com</a>
                                </h6>
                                <h6 class="mb-3">
                                    Order delivery
                                    <a href="https:testbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com" style="display: block; word-wrap: break-word; max-width: 300px">https:testbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com</a>
                                </h6>
                                <div>
